...
public class TrieST26<Value> {
    private static final int R = 26;        // 26 letters
   ...
   /**
    ...
    /**
     * Unit tests the {@code TrieST26} data type.
     *
    ...
    public static void main(String[] args) {
        ...
        StdOut.println("longestPrefixOf(\"QUIETSORT\"):");
        StdOut.println(st.longestPrefixOf("QUIETSORT"));
        StdOut.println();

        StdOut.println("containsPrefix(\"SHOR\"):");
        StdOut.println(st.containsPrefix("SHOR"));
        StdOut.println();
